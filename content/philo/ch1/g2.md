...
*Une exception : le [Kosmothéoros](../def.md#-le-kosmotheoros)*
...
Les idées sont chargés d'[[../def.md#Affects]], on a toujours en nous une idée plus forte qu'une autre. Exemple avec le Cannibalisme : une idée, deux affects fondamentale différents (j'aime/t'es fou)
